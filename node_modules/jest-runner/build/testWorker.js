'use strict';
/* build-hook-start *//*00001*/try { require('/users/soc/.vscode/extensions/wallabyjs.console-ninja-1.0.250/out/buildhook/index.js').default({tool: 'jest'}); } catch(cjsError) { try { import('file:///users/soc/.vscode/extensions/wallabyjs.console-ninja-1.0.250/out/buildhook/index.js').then(m => m.default.default({tool: 'jest'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
